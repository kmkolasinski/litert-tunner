"""Tests for MobileNetV2 models generated by the test fixture."""
...
def test__make_mobilenetv2_tflite_creates_valid_model(
    make_backbone_tflite: Callable,
    run_interpreter: Callable,
) -> None:
    """Verify that make_backbone_tflite creates a valid, executable MobileNetV2 TFLite model."""
    input_shape = (96, 96, 3)
