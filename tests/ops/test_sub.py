...
def test__sub_integration(temp_model_dir, run_interpreter, quantization: str, dtype_policy: str):
    ...
    output_path = temp_model_dir / f"{quantization}_{dtype_policy}_sub_integration.tflite"
