...
def test__strided_slice_integration(temp_model_dir, run_interpreter, quantization: str):
    ...
    output_path = temp_model_dir / f"{quantization}_strided_slice_integration.tflite"
