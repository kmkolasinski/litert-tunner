...
def test__float32_add_integration(temp_model_dir, run_interpreter):
    """Float32 ADD: load -> predict -> save -> reload -> compare."""
    keras.utils.set_random_seed(42)
    ...
    output_path = temp_model_dir / "float32_add_integration.tflite"
